...
package com.lorcan.spinnerwheel;
...
import com.lorcan.spinnerwheel.adapters.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        TypedArray
            a = getContext().obtainStyledAttributes(attrs, R.styleable.AbstractWheelView, defStyle, 0);
